...
│   │   │   ├── maps
│   │   │   │   ├── map.pgm                    # map files of myworld.world, generated by pgm_map_creator
├── video.gif                                  # Video gif
├── video.mp4                                  # Video fle
``` 
...
- [map.pgm](/catkin_ws/src/my_robot/maps/map.pgm): Generated myworld map
- [map.yaml](/catkin_ws/src/my_robot/maps/map.yaml): Info for myworld map
- [default.rviz](/catkin_ws/src/my_robot/rviz/default.rviz): Default rviz
- [map.pgm](/catkin_ws/src/pgm_map_creator/maps/map.pgm): Generated myworld map

## Run the project  
* Clone this repository
```
git clone https://github.com/adheeshc/ROS_Localization.git
```
